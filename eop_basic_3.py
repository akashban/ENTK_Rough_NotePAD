...
# xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx 
    ...
    t1.arguments = ['mdrun',
                    ...
                    'table',
                    '-v']
    t1.post_exec =[' tar ' + ' -czvf ' + 'jump.tar.gz' + ' conf.gro ' + ' table_1.gro ']
...
# XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    ...
    t4 = Task()
    t4.name ='t4'
    t4.copy_input_data = ['/home/polo-mastaan/Desktop/ENTK/radical.entk/10_15_2019/read_1.py',
                          '/home/polo-mastaan/Desktop/ENTK/radical.entk/10_15_2019/grompp_A.mdp',
                           '/home/polo-mastaan/Desktop/ENTK/radical.entk/10_15_2019/grompp_B.mdp',
                           '$Pipline_%s_Stage_%s_Task_%s/jump.tar.gz' % (p.name, s1.name, t1.name)]


    t4.pre_exec =[' tar ' + ' xvf ' + ' jump.tar.gz ']
    
    t4.executable = 'python'
    t4.arguments = ['read_1.py']
...
#----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    # Create a Task object in stage3
# XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    t5 = Task()
    t5.name ='t5'
    t5.copy_input_data = ['$Pipline_%s_Stage_%s_Task_%s/file.tar.gz' % (p.name, s2.name, t4.name),
                          '$Pipline_%s_Stage_%s_Task_%s/topol.top' % (p.name, s1.name, t1.name),
                          '$Pipline_%s_Stage_%s_Task_%s/index.ndx' % (p.name, s1.name, t1.name),
                          '$Pipline_%s_Stage_%s_Task_%s/conf.gro' % (p.name, s1.name, t1.name),
                          '$Pipline_%s_Stage_%s_Task_%s/table.xvg' % (p.name, s1.name, t1.name),
    ...
    t5.executable = '/usr/local/gromacs/bin/./gmx'

    t5.pre_exec =[' tar ' +  ' xvf ' + ' file.tar.gz ',
                  '/usr/local/gromacs/bin/./gmx' + ' grompp -f grompp_*.mdp -c conf.gro -p topol.top -o table.tpr -n index.ndx']
    ...
    t5.arguments = ['mdrun',
                    ...
                    'table',
                    '-v']
    t5.post_exec =[' mv ' + ' table.gro ' + ' table_3.gro ',
                   ' pwd ']
# XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

    # Add the Task to the Stage23
    s3.add_tasks(t5)
#----------------------------------------------------------------------------------------------------------------------------------------------------
